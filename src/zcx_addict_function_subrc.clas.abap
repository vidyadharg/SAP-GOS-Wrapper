CLASS zcx_addict_function_subrc DEFINITION
  PUBLIC
 ...
 PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF c_addict_function_subrc,
      ...
      END OF c_addict_function_subrc.
    CONSTANTS:
...
*      END OF no_result_returned.
    ...
    CLASS-METHODS raise_if_sysubrc_not_initial
      ...
      RAISING   zcx_addict_function_subrc.
...
CLASS zcx_addict_function_subrc IMPLEMENTATION.
  METHOD constructor ##ADT_SUPPRESS_GENERATION.
    ...
    IF textid IS INITIAL.
      if_t100_message~t100key = c_addict_function_subrc.
    ELSE.
  ...
  METHOD raise_if_sysubrc_not_initial.
    ...
    RAISE EXCEPTION TYPE zcx_addict_function_subrc
      EXPORTING funcname = funcname
                param    = parameter
                stext    = stext
                subrc    = subrc_bak
                textid   = zcx_addict_function_subrc=>subrc_error.
  ENDMETHOD.
ENDCLASS.
